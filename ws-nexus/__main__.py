...
UA_DIR = 'ua'
URL_UA_JAR = 'https://github.com/whitesource/unified-agent-distribution/releases/latest/download/wss-unified-agent.jar'
URL_UA_CONFIG = "https://github.com/whitesource/unified-agent-distribution/raw/master/standAlone/wss-unified-agent.config"
ERROR = 'error'
SUCCESS = 'SUCCESS'
FAILED = 'FAILED'
JAR_EXTENSION = 'jar'
